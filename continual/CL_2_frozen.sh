...
python -m torch.distributed.launch \
    ...
    main_continual.py \
        ...
        --drop_path 0.1 \
        --exp-name ${EXP} \
        --data_path  /gpfs/u/home/AICD/AICDzich/scratch/vl_data/transfer/stanford_car \
        --finetune /gpfs/u/home/AICD/AICDzich/scratch/work_dirs/VLMOE/CL1_tiny_frozen/save-299.pth \
        --frozen \
        --fix_kv \
