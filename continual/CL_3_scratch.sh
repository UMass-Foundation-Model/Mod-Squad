...
python -m torch.distributed.launch \
    ...
    main_continual.py \
        ...
        --model vit_task3_tiny \
        --drop_path 0.1 \
        --exp-name ${EXP} \
        --data_path  /gpfs/u/home/AICD/AICDzich/scratch/vl_data/transfer/aircraft \
        --finetune /gpfs/u/home/AICD/AICDzich/scratch/work_dirs/VLMOE/CL2_tiny_frozen/save-299.pth \
