...
python -m torch.distributed.launch \
    ...
    main_continual.py \
        ...
        --model vit_task1_small \
        --drop_path 0.1 \
        --data_path /gpfs/u/home/AICD/AICDzich/scratch/vl_data/transfer/imgnet_1 \
        --finetune /gpfs/u/home/AICD/AICDzich/scratch/work_dirs/VLMOE/curriculum_0_small/save-399.pth \
        --exp-name ${EXP} \
        --frozen \
        --fix_kv \
        --eval_all \
