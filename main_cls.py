...
# python -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --master_port 44875 main_cls.py \
#       --batch_size 64 \
#       --model vit_fix_moe_small \
#       --epochs 800 \
#       --input_size 224 \
#       --blr 5e-4 \
#       --layer_decay 0.65 \
...
#       --weight_decay 0.05 \
#       --reprob 0.25 --mixup 0.8 --cutmix 1.0 \
#       --exp-name debug_vit_fix_moe_small \
...
if __name__ == '__main__':
    ...
    code_path = os.getcwd()
    if code_path.startswith('/nobackup'):
        ...
        print('Detect that you are using satori!')
