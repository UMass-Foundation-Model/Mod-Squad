...
source /gpfs/u/home/LMCG/LMCGzich/barn/miniconda3/etc/profile.d/conda.sh
conda activate VLC2
...
### the command to run
cd /gpfs/u/home/LMCG/LMCGzich/barn/code/MTMoe/
...
python -m torch.distributed.launch \
    ...
    main_mt.py \
        ...
        --cycle \
        --tasks 14 \
        --model mtvit_topk_taskgate_mlp16E4_small \
        --drop_path 0.1 \
        --exp-name ${EXP} \
