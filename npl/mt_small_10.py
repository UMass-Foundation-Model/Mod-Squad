...
def run_main():
    ...
    src_file = '/gpfs/u/home/AICD/AICDzich/barn/code/MTMoe/npl/mt_small_10.sh'
    tgt_file = '/gpfs/u/home/AICD/AICDzich/barn/code/MTMoe/npl/save/' + str(dt_string)+ str(exp_name)+'.sh'
