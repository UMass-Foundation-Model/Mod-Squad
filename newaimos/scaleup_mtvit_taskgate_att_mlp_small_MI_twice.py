...
def run_main():
    ngpus = 6   
    nodes = 32
    exp_name = 'scaleup_mtvit_taskgate_att_mlp_small_MI_twice_gg'
    ...
    src_file = '/gpfs/u/home/AICD/AICDzich/barn/code/MTMoe/newaimos/scaleup_mtvit_taskgate_att_mlp_small_MI_twice.sh'
