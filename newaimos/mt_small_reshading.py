...
def run_main():
    ngpus = 6    
    nodes = 4
    exp_name = 'scaleup_mt_base_reshading_2e-4'
    world_size = ngpus * nodes
    # datetime reshading containing current date and time
    now = datetime.now()
    ...
    src_file = '/gpfs/u/home/AICD/AICDzich/barn/code/MTMoe/newaimos/mt_small_reshading.sh'
