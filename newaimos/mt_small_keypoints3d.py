...
def run_main():
    ngpus = 6   
    nodes = 4
    exp_name = 'scaleup_mt_base_keypoints3d_2e-4'
    world_size = ngpus * nodes
    # datetime keypoints3d containing current date and time
    now = datetime.now()
    ...
    src_file = '/gpfs/u/home/AICD/AICDzich/barn/code/MTMoe/newaimos/mt_small_keypoints3d.sh'
