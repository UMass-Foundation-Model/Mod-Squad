...
def run_main():
    ngpus = 6   
    nodes = 40
    exp_name = 'scaleup_mtvit_taskgate_att_mlp_base_MI_twice_ggg'
    ...
    src_file = '/gpfs/u/home/AICD/AICDzich/barn/code/MTMoe/newaimos/scaleup_mtvit_taskgate_att_mlp_base_MI_twice.sh'
